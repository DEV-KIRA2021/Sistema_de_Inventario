...
public class frmConsultaProductoXCodigo extends JDialog implements KeyListener, ActionListener {
	...
	public static void main(String[] args) {
		try {
			frmConsultaProductoXCodigo dialog = new frmConsultaProductoXCodigo();
	 ...
	 * Create the dialog.
	 */
	public frmConsultaProductoXCodigo() {
		setModal(true);
		...
		}
		{
			...
			bnEnviar.setIcon(new ImageIcon(frmConsultaProductoXCodigo.class.getResource("/iconos/add.png")));
	...
	protected void actionPerformedBnEnviar(ActionEvent e) {
		...
		frmEntradaProductos.txtCodPro.setText(cod);
		frmEntradaProductos.txtDescripcion.setText(des);
		dispose();
	}
