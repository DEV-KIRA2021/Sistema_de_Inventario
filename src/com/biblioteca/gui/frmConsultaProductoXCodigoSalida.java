...
public class frmConsultaProductoXCodigoSalida extends JDialog implements KeyListener, ActionListener {
	...
	public static void main(String[] args) {
		try {
			frmConsultaProductoXCodigoSalida dialog = new frmConsultaProductoXCodigoSalida();
	 ...
	 * Create the dialog.
	 */
	public frmConsultaProductoXCodigoSalida() {
		setModal(true);
		...
		}
		{
			...
			bnEnviar.setIcon(new ImageIcon(frmConsultaProductoXCodigoSalida.class.getResource("/iconos/add.png")));
	...
	protected void actionPerformedBnEnviar(ActionEvent e) {
		...
		frmSalidaProductos.txtCodPro.setText(cod);
		frmSalidaProductos.txtDescripcion.setText(des);
		dispose();
	}
	...
	void listadoProductosXCodigo(String cod){
		...
		model.setRowCount(0);
		ArrayList<Producto> lista=new MySqlProductoDAO().findAllByProducto(cod);
